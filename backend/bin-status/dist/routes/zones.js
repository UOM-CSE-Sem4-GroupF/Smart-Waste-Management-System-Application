        ...
        try {
            ...
            const data = zoneIds.map((zone_id) => {
                ...
                return {
                    ...
                    active_jobs: store_1.store.getActiveJobsCountForZone(Number(zone_id)),
                };
            });
            ...
            logger.error({ error: error instanceof Error ? error.message : String(error) }, 'Failed to fetch zones');
