...
*This document is the authoritative context for Claude Code sessions.When working on any service, read this file first.For service-specific API details see group-f-docs/service-specifications.mdLast updated by F4 platform team*